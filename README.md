This repository contains the source code of the external Server, which was build using **.NET 5**.<br/>(for a project overview see [SmartGardeningSystem](https://github.com/Bernd-H/DA_SmartGardeningSystem))
